...
public class FileType
{
     ...
     * 根据文件名返回文件类型
     * @param fileName 文件名
     * @return 0:图片，1：文档，2：视频，3：音乐，4：其他
     * */
    public static int fileType(String fileName)
    {
        ...
        else
        {
            ...
            // 创建视频类型数组2
            String[] video = { "mp4", "avi", "mov", "wmv", "asf", "navi", "3gp",
                    "mkv", "f4v", "rmvb", "webm" };
     ...
     * 根据文件名判断是否指定的文件类型
     * @param fileName 文件名
     * @param targetType 文件类型
     * */
    public static boolean isValidType(String fileName, String targetType)
    {
        if (fileName == null || targetType == null)
        {
            return false;
        }
     ...
     // 获取文件后缀名并转化为写，用于后续比较
        ...
        if (fileType.trim().equalsIgnoreCase(targetType.trim()))
        {
            return true;
        }
        return false;
